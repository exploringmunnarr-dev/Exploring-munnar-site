...
export const metadata = {
  title: "Munnar Attractions – Waterfalls, Viewpoints & Parks",
  description:
    "Explore popular attractions near Munnar including waterfalls, viewpoints, tea estates, and nature parks. Full list with distance and highlights.",
};
    ...
    <>
      ...
      <div className="main-container mx-4 md:mx-10 mt-4">
        <div className="heading-container">
          ...
          <h1 className="text-[#777777] md:w-[60%] max-sm:text-sm text-lg mt-2">
            From misty treehouses to warm homestays — browse handpicked stays
            for every kind of traveler.
          </h1>
        </div>
        {/* tab container  */}
        <NearByAttractionsTab routes={routes} />
        {/* card contaienr  */}
        <div className="card-container grid sm:grid-cols-2 md:grid-cols-3 gap-4 mt-4">
          {data.map((item, index) => {
            return (
              <Link
                href={`/nearByAttractions/${item.title}`}
