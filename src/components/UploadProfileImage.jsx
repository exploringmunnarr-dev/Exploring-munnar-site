      ...
      >
        <div className="container-1 relative">
          <header className="py-2 px-4 items-center  flex justify-between">
            ...
            <X
              onClick={() => setUploadImgModal(false)}
            ...
            <div className="container-1 relative text-center border-2 border-dashed border-gray-300 rounded-lg p-6">
              {file ? (
                ...
                <div>
                  ...
                  <button className="bg-[#eeeeee] px-3 py-2 rounded-md mt-2 cursor-pointer hover:bg-gray-200">
                    Choose File
                  </button>
                  <input
                    ...
                    type="file"
                    accept="image/*"
                    className="bg-gray-500  absolute top-0 right-0 left-0 bottom-0 opacity-0"
                  />
                </div>
              )}
            </div>
          ...
          {file && (
            <div className="preview-container px-4 ">
          ...
          <div className="footer-container w-[100%] flex gap-3 justify-end py-3 px-4">
            <button
              onClick={() => setUploadImgModal(false)}
              className="px-4 py-2 rounded-lg text-black bg-gray-300 cursor-pointer "
            >
              Cancel
            </button>
            <button className="bg-[linear-gradient(90deg,#216432_0%,#114422_89.42%)] hover:bg-[linear-gradient(90deg,#AF4300_0%,#AF4300_100%)] px-4 py-2 rounded-lg text-white cursor-pointer ">
              Save
            </button>
          </div>
        </div>
