  ...
  return (
    <>
      ...
      <div className="relative mt-4 md:mt-8 py-6 md:py-8 mx-4 md:mx-10">
        <h1 className="text-xl md:text-3xl font-semibold text-[#333333]">What Travelers Are Experienced</h1>
        <h1 className="text-[#777777] mt-2 mb-8">Real experiences from real visitors who explored Munnar with us.</h1>
        <Swiper
        ...
        >
          {testimonials.map((item, index) => (
            <SwiperSlide key={index}>
              {({ isActive }) => (
                <div
                  className={`transition-all duration-500 p-6 shadow-md rounded-2xl ${isActive
                    ? " btn-green text-white rounded-2xl"
                      : "scale-90 bg-[#EEEEEE] text-[#425466] rounded-2xl"
                    }`}
                >
