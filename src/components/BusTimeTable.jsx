  ...
  return (
    <>
      <section className='mx-4 md:mx-10 mt-8'>
        <header className=''>
          <h1 className='text-[#333333] text-xl md:text-3xl'>Plan your journey with realtime bus schedules</h1>
          <h1 className='text-[#777777] mt-2 text-lg'>Select your favourite Munnar spot and browse available stays.</h1>
        </header>
        {/* ------------------------------- root container  --------------------------------  */}
        <div className="root-container mt-4 bg-[#EEEEEE] grid sm:grid-cols-12 md:grid-cols-3 gap-1 md:gap-3 md:p-4 rounded-lg">
          <div className="p-2  sm:col-span-6 md:col-span-1 ">
            ...
            <div className="input-container border-2 border-[#777777] bg-white rounded-lg px-4 py-2 flex items-center justify-between mt-2">
              <h1 className='text-[#777777] hidden sm:block '>Munar</h1>
          ...
          <div className="p-2 sm:col-span-6 md:col-span-1 ">
            ...
            <div className="input-container border-2 border-[#777777] bg-white rounded-lg px-4 py-2 flex items-center justify-between mt-2">
              <h1 className='text-[#777777]  hidden sm:block'>Kochi</h1>
