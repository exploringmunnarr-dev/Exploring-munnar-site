        ...
        <header className="w-full px-4 md:px-10 py-1  bg-[#EBEBEB] sticky top-0 z-50">
            <div className="main-container flex justify-between ">
                <div className="flex items-center space-x-2 ">
                    <Image src={logo} alt="explore Munar" width={100} className=" w-[100px] md:w-[100px]" />
                </div>
                <nav className="hidden md:flex items-center w-fit translate-x-[50px]  space-x-6 text-lg text-gray-700 font-medium">
                    <Link href="/" className={`${pathname === "/" ? "text-green-700 font-medium" : ""}`}> Home</Link>
                    <span>|</span>
                    <Link href="/our_company" className={` ${pathname.includes("our_company") ? "text-green-700" : ""} `}>Our Company</Link>
                    <span>|</span>
                    <Link href="/contact_us" className={` ${pathname.includes("contact_us") ? "text-green-700" : ""} `}>Contact us</Link>
                </nav>
                ...
                <div className="flex items-center space-x-4 ">
                    ...
                    <div className="bg-white p-2 rounded-lg flex items-center gap-2 relative">
                        <div className="icon-container">
                            {isSidebar ? <X onClick={() => setIsSidebar(false)} className="text-gray-700 cursor-pointer" /> : <Image
                        ...
                        {isSidebar && <div className="sidebar-container absolute top-full right-4">
                            <Sidebar />
                        </div>}
                        <Image
                            src={profile}
