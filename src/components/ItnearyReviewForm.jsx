...
const routes_data = [
    ...
    { route: "Munnar rose garden", distance: "4km from mettupaty", img: routeImg1 },
    { route: "Munnar rose garden", distance: "6km from mettupaty", img: routeImg1 },
    { route: "Munnar rose garden", distance: "3km from mettupaty", img: routeImg1 },
]
            ...
            <section className='bg-white rounded-xl p-6 space-y-8'>
                <div className="container-1 border-b md:border-none pb-2 md:pb-0 border-gray-300 flex items-center justify-between">
                    <header className='w-[100%]'>
                        <h1 className='text-[#246132] text-lg font-semibold flex items-center gap-2'><span><Image src={personalInfoIcon} /></span>Personal info</h1>
                    ...
                    <Image onClick={() => setStep("personal_info")} src={edit_icon} className='cursor-pointer' />
                </div>
                <div className="container-2 border-b md:border-none pb-2 md:pb-0 border-gray-300 flex items-center justify-between">
                    <header className='w-[100%]'>
                        <h1 className='text-[#246132] text-lg font-semibold flex items-center gap-2'><span><Image src={calendar} /></span>Trip dates & group details</h1>
                    ...
                    <Image src={edit_icon} onClick={() => setStep("trip_date")} className='cursor-pointer' />
                </div>
                <div className="container-2 border-b md:border-none pb-2 md:pb-0 border-gray-300 flex items-center justify-between">
                    <header className='w-[100%]'>
                        <h1 className='text-[#246132] text-lg font-semibold flex items-center gap-2'><span><Image src={accomodation} className='w-7' /></span>Accomodation</h1>
                ...
                <div className="container-2 border-b md:border-none pb-2 md:pb-0 border-gray-300 flex items-center justify-between">
                    <header className='w-[100%]'>
                        <h1 className='text-[#246132] text-lg font-semibold flex items-center gap-2'><span><Image src={car_icon} className='w-7' /></span>Transports</h1>
                        <div className="content-container text-[#333333] md:flex items-center justify-between  md:w-[50%] mt-2 md:mt-3 text-lg">
                            <h1>Yes, Private</h1>
                ...
                <div className="container-2 md:border-none pb-2 md:pb-0 border-gray-300 flex items-center justify-between">
                    <header className='w-[100%]'>
                        <h1 className='text-[#246132] text-lg font-semibold flex items-center gap-2'><span><Image src={routes_icon} className='w-7' /></span>Routes</h1>
                    ...
                    {routes_data.map((item, index) => {
                        return <>
                            <div className="main-container flex gap-4 items-center">
                                <input type="checkbox" checked={true} className='scale-125 accent-[#AF4300]' />
                                <div className='flex items-center gap-3'>
                                    <Image src={item.img} />
                                    <div className='text-lg'>
                                        <h1 className='text-black md:text-[#333333] text-sm md:text-lg '>{item.route}</h1>
                                        <h1 className='text-[#333333] text-sm md:text-lg'>{item.distance}</h1>
                                    </div>
                                </div>
                            </div>
                        </>
                ...
                <div className="text-box-container ">
                    <h1 className='flex items-center gap-3 text-[#333333] font-semibold text-lg'><span><Image src={bell} className='w-4' /></span>Notes</h1>
                    <textarea className='min-h-[100px] max-h-[100px] p-2 border-1 outline-none border-[#777777] rounded-lg w-[100%] mt-4'>
                    </textarea>
                </div>
