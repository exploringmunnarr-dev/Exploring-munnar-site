...
const ItnearyHeader = () => {
    ...
    return (
        <>
            <header className='mx-4 md:mx-10 mt-4 btn-green px-4 py-4 md:py-10 rounded-lg'>
                <SubCardNav/>
                <div className="content-container text-white mt-4 md:ml-3">
                    <h1 className='font-semibold text-lg md:text-3xl '>Plan Your Perfect Munnar Trip</h1>
