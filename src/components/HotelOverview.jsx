...
const HotelOverview = ({ data, handleOpenSuccessPopup }) => {
  ...
  return (
    <>
          ...
          <div className="w-full rounded-xl p-4 bg-[#EEEEEE]">
            ...
            <div className="flex justify-between items-center">
              <p className="text-lg font-semibold">
                ₹{data?.pricePerNight} <span className="text-gray-600 text-sm">/ night</span>
              </p>
            ...
            <div className="mt-2 border border-[#777777] rounded-md px-3 py-2 bg-white flex justify-between items-center cursor-pointer">
              <div>
                ...
                <input type="text" placeholder="1" className="text-sm text-gray-500 outline-none" />
      ...
      {isForm && <HotelEnquiryForm setIsForm={setIsForm} data={data} handleOpenSuccessPopup={handleOpenSuccessPopup} />}
    </>
  );
};
