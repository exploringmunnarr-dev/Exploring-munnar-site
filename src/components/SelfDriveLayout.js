...
export default function SelfDriveLayout() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage = err.response?.data?.message || err.message || "An error occurred while submitting your booking";
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            <div className="relative">
              ...
              <input
                ...
                className={`w-full border rounded-lg pl-3 pr-4 py-2 outline-none placeholder-gray-400 text-black ${errors.name ? "border-red-500" : "border-gray-300"
                  }`}
              />
              {errors.name && (
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full border rounded-lg pl-3 pr-4 py-2 outline-none placeholder-gray-400 text-black ${errors.email ? "border-red-500" : "border-gray-300"
                  }`}
              />
              {errors.email && (
