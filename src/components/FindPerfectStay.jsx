      ...
      <section className='mt-8 md:mt-14 h-[200px] md:h-[340px]'>
        <div className="img-container relative h-[100%]">
          ...
          <div className="content-container md:w-[40%] absolute top-[45%] translate-y-[-50%] left-[7%] text-white">
            ...
            <button className=' bg-[linear-gradient(90deg,#216432_0%,#114422_89.42%)] hover:bg-[linear-gradient(90deg,#AF4300_0%,#AF4300_100%)] text-white rounded-lg px-4 py-2 mt-3 cursor-pointer'>Browse Hotels Now</button>
          </div>
        </div>
      </section>
    </>
