    ...
    <>
      ...
      >
        <div className="navlinks ">
          <Link href={"/wishlists"} className="w-[90%] m-auto rounded-lg text-left hover:bg-[linear-gradient(90deg,#216432_0%,#114422_89.42%)] hover:text-white px-4 py-2 cursor-pointer flex items-center gap-2 group">
